describe('Háromszög kerületszámítása', () => {
    ...
    it('1, 135 inputra 40 kerület', () => {
        let act = calcPerimeter(1, 135);
        expect(act).toBe(4)
    })
})

describe('Háromszög területszámítása', () => {
    it('30, 35 inputra 516.22 terület', () => {
        let act = calcArea(30, 35);
        expect(act).toBeCloseTo(516.22, 0.9);
    });

    it('130, 135 inputra 11950.10 terület', () => {
        let act = calcArea(130, 135);
        expect(act).toBeCloseTo(11950.10, 0.9);
    });
    
    it('1, 135 inputra 0.71 terület', () => {
